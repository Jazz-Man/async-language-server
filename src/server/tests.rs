...
use async_lsp::lsp_types::{
    ClientCapabilities, DiagnosticOptions, DiagnosticServerCapabilities, Hover, HoverContents,
    HoverParams, MarkedString, Position, Range as LspRange, ServerCapabilities,
};
...
impl RawClient {
    ...
    async fn read_to_end(&mut self, out: &mut Vec<u8>) -> std::io::Result<usize> {
...
// --- catalog #10-#11 (shutdown + server→client requests) ---
