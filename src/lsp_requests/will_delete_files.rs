...
pub(crate) struct WillDeleteFilesRequest;

#[cfg(test)]
mod tests {
    use std::collections::HashMap;

    use async_lsp::lsp_types::{DeleteFilesParams, TextEdit, WorkspaceEdit};
    use lsp_macros::conversion_tests;

    use crate::lsp_requests::WillDeleteFilesRequest;
    use crate::testing::{line_position, same_line};

    conversion_tests! {
        will_delete_files_edits_convert_outgoing: WillDeleteFilesRequest {
            params: |_uri| DeleteFilesParams::default(),
